...
[source,bash]
----
{prompt.root}curl -sfL https://get.k3s.io | INSTALL_K3S_SKIP_SELINUX_RPM=true sh
----

Installing as non-{rootuser} user:
[source,bash]
----
{prompt.user}curl -sfL https://get.k3s.io | INSTALL_K3S_SKIP_SELINUX_RPM=true sh -s - --write-kubeconfig-mode 644
----
====
...
[source,bash]
----
{prompt.root}curl https://raw.githubusercontent.com/helm/helm/master/scripts/get-helm-3 | bash
----
====
...
include::systemd-install.adoc[leveloffset=+1]
include::container-install.adoc[leveloffset=+1]
include::ansible-install.adoc[leveloffset=+1]