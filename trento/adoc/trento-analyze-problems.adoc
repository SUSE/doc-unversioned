...
+
....
{prompt.root}wget https://raw.githubusercontent.com/trento-project/support/refs/heads/main/trento-support.sh
....
+
[NOTE]
...
to work, you need a host where kubectlis installed and connected to the
