...
For more information about `podman build` options, see the https://docs.podman.io/en/latest/markdown/podman-build.1.html[official Podma documentation] .
...
[[sec-sle-images-customizing-the-images-extensions]]
...
then deploying containers based on theimage.
