...
https://buildah.io[{buildah}] is a utility for building OCI container images. It is a complementary
...
storage back-ends. {skopeo} is part of the `Basesystem Module` of {slesa}.
